...
1. Read `PROJECT.md` for project name, status, priority, autonomy
2. Find the active iteration (scan `iterations/*/ITERATION.md` for `Status: active`)
